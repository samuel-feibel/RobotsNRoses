...
//  byte tslb_val = read_register_value(0x3A);
//  Serial.print("after write: TSLB ");
//  Serial.println(tslb_val, HEX);
  read_key_registers();
  ...
  delay(100);
  write_key_registers();
  //OV7670_write_register(0x3A, 0x2C); // enable negative image
//  byte tslb_val = read_register_value(0x3A);
//  Serial.print("after write: TSLB ");
//  Serial.println(tslb_val, HEX);
  read_key_registers();
...
void write_key_registers(){
    ...
    //OV7670_write_register(COM15_ADDR, 0xF0); //RGB 555
//    OV7670_write_register(COM15_ADDR, 0xD0); //RGB 565
//    OV7670_write_register(0x8C, 0x00); // RGB 565
//    
...
//    
    ...
    //OV7670_write_register(0x0D, 0x40);
    //V7670_write_register(0x66, 0xFF);
    
}

void read_key_registers(){
  byte com4_val = read_register_value(0x0D);
  Serial.print("COM4 ");
  Serial.println(com4_val, HEX);
  byte com10_val = read_register_value(0x15);
  Serial.print("COM10 ");
  Serial.println(com10_val, HEX);
