...
const byte COM7_SET  = 0x0C; //0x0E; //0x0C; // RGB output and QCIF res
const byte COM9_SET  = 0x0B; // AGC = 2x, freeze AGC
const byte CLKRC_SET = 0xC0; // use external clock directly
const byte COM15_SET = 0xD0; // RGB565 0xF0; // RGB555
const byte COM17_SET = 0x0C; // dsp color bar enable 
...
void write_key_registers(){
    ...
    //OV7670_write_register(0x66, 0xFF);
